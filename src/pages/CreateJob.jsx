        ...
        <Grid container className={classes.column}>
            ...
            <Grid container className={classes.column}>
                <Grid xs={6} container className={classes.column}>
                    ...
                    />
                    <Grid container className={classes.row + " " + classes.picker}>
            ...
            <Grid container className={classes.column}>
                ...
                <LocalizationProvider dateAdapter={DateAdapter}>
                    <Grid xs={6} container className={classes.row}>
                        ...
                        <Grid container className={classes.row}>
                            <Grid container xs={6} className={classes.picker}></Grid>
                            {
                                isService ? 
                                    <Grid container xs={6} className={classes.columnsContainerRight}>
                                        <FormGroup>
